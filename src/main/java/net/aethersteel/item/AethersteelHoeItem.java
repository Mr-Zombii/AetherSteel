...
public class AethersteelHoeItem extends HoeItem {
    public AethersteelHoeItem() {
        super(new Tier() {
            public int getUses() {
                return 3811;
            }
        ...
        }, 0, 1.7F, (new Item.Properties()).tab(AethersteelModTabs.TAB_AETHERSTEEL_CREATIVE_TAB).setNoRepair());
    }
