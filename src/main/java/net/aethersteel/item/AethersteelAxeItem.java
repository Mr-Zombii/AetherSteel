...
public class AethersteelAxeItem extends AxeItem {
    public AethersteelAxeItem() {
        super(new Tier() {
            public int getUses() {
                return 3811;
            }
        ...
        }, 1.0F, -0.3F, (new Item.Properties()).tab(AethersteelModTabs.TAB_AETHERSTEEL_CREATIVE_TAB).setNoRepair());
    }
