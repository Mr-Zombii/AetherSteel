...
public class AethersteelShovelItem extends ShovelItem {
    public AethersteelShovelItem() {
        super(new Tier() {
            public int getUses() {
                return 3811;
            }
        ...
        }, 1.0F, -1.3F, (new Item.Properties()).tab(AethersteelModTabs.TAB_AETHERSTEEL_CREATIVE_TAB).setNoRepair());
    }
