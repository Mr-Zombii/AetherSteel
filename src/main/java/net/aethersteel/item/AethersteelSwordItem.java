...
public class AethersteelSwordItem extends SwordItem {
    public AethersteelSwordItem() {
        super(new Tier() {
            public int getUses() {
                return 3811;
            }
        ...
        }, 3, 0.0F, (new Item.Properties()).tab(AethersteelModTabs.TAB_AETHERSTEEL_CREATIVE_TAB).setNoRepair());
    }
